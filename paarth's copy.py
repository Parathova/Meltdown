...
while Start == False:
    ...
    print (player_name)
    text_surface = defont.render(player_name, None, (0, 255, 255))
    name_popup = imgImport('news.png', 0.5*WIDTH, 0.6*HEIGHT)
    WIN.blit(name_popup, (0.37*HEIGHT, 0.2*WIDTH))
    WIN.blit(text_surface, (0.37*HEIGHT+20, 0.2*WIDTH+100))
    pyg.display.update()
